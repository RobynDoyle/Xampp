...
{
//store the data posted in the form in variables and use real escape string to clean data fields the
...
description='$description', longdescription='$longdesc', vendor_email='$vendor_email',
categoryid='$categoryid', image='$image' WHERE productid=$productid";
