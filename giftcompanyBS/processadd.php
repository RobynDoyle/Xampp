...
$sql_insert="INSERT INTO product(productname, price, description, longdescription, vendor_email,
categoryid, image) VALUES ('$product', '$price', '$description', '$longdesc', '$vendor_email',
'$categoryid', '$image')";
if(mysqli_query($link, $sql_insert)) {
    echo "Your product has been successfully added <p>";
    echo "<a class='btn btn-outline-primary mt-5' href='manageproducts.php'>Return to Manage
    Products page</a>";
    }
    else {
