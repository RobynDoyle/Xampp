...
$sql="SELECT * from product, category WHERE product.categoryid=$categoryid AND
...
echo "<div class='card-body'>"; //this BS div adds a horizontal rule and holds the product name, description and price
echo "<hr>";
