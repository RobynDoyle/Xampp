...
$sql="SELECT * FROM product, category WHERE productid=$productid AND
...
<input type="hidden" name="productid" value="<?php echo $productid; ?>"/> <!--productid is not
displayed but needed to update the correct record in the processedit page-->
<label for="productname">Product Name:</label>
<div><input type="text" name="productname" id="productname" class="form-control mt-2 mb-2"
value="<?php echo $productname; ?>" required/></div>
<label for="price">Price:</label>
<div><input type="number" name="price" id="price" step="0.01" min="0" class="form-control mt-2
mb-2" value= "<?php echo $price; ?>" required /></div>
<label for="description">Description:</label>
<div><textarea name="description" id="description" class="form-control mt-2 mb-2" rows="8"
cols="35" required><?php echo $desc; ?> </textarea>
</div>
<label for="longdescription">Long Description:</label>
<div><textarea name="longdescription" id="longdescription" class="form-control mt-2 mb-2"
rows="8" cols="35" required><?php echo $longdesc; ?></textarea></div>
...
echo "<option value='$vendor_email'>$vendor_email</option>"; //set the value of the option
}
}
?>
</select>
...
$categoryid=$row['categoryid'];
echo "<option value='$categoryid'>$categoryname</option>"; //set the value of the option
}
}
mysqli_close($link);
?>
...
<div><input type="text" id="image" name="image" class="form-control mt-2 mb-2" value="<?php
echo $image; ?>" required /></div>
<div><input type="submit" class="btn btn-outline-primary mt-5" name="submit" value="Edit
Product"/></div>
</form>
</div>
</section>
