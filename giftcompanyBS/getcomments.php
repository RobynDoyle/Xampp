...
echo "<table class='table table-bordered table-striped'>"; /*add the table class and use BS table
styles to make more readable */
echo "<tr>
<th> Title</th>
<th>Content</th>
<th>Author</th>
...
<div class="mt-3">
<button type="submit" class="btn btn-outline-primary mb-5 mt-3
">Add Comment</button>
</div>
</form> 
</div>
