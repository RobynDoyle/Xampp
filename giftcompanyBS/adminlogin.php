...
<div><input type="email" class="mt-2 mb-2 form-control" name="admin_email" placeholder="Enter
username" required></div>
<label for="password">Password: </label>
<div><input type="password" class="mt-2 mb-2 form-control" name="password"
