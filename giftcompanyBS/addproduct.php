...
<div><input class="mt-2 mb-2 form-control" type="text" name="productname" id="productname"
placeholder="Enter product name" required/></div>
<label for="price">Price</label>
<div><input class="mt-2 mb-2 form-control" type="number" name="price" id="price" step="0.01"
min="0" placeholder="0.00" required /></div>
<label for="description">Description</label>
<div><textarea class="mt-2 mb-2 form-control" name="description" id="description" rows="8"
cols="35" placeholder="Enter product short description" required ></textarea>
</div>
<label for="longdescription">Long Description:</label>
<div><textarea class="mt-2 mb-2 form-control" name="longdescription" id="longdescription"
rows="8" cols="35" placeholder="Enter product long description" required></textarea></div>
...
<div><input class="mt-2 mb-2 form-control" type="text" id="image" name="image"
placeholder="Enter image path" required /></div>
<div><input type="submit" class="btn btn-outline-primary mt-5 mb-5" name="submit" value="Add
Product"/></div>
</form>
