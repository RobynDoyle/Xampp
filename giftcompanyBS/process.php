...
$title=mysqli_real_escape_string($link,$_POST["title"]); /*escapes special characters in a string for
use in an SQL query*/
...
echo "<h4>Testimonial Added!</h4>Thank you for your feedback. Our administrators moderate all
comments and it will be attended to shortly<p>";
echo "<a class='btn btn-outline-primary mt-3' href='getcomments.php'>Return to Testimonials
page</a>";}
else {
