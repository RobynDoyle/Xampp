...
<td>&euro; $price</td>
<td>$productdesc</td>
<td><a href='editproduct.php?productid=$productid' class='btn btn-outlineprimary'>Update</a></td>
<td><a href='confirmdeleteproduct.php?productid=$productid' class='btn btn-outlineprimary'>Delete</a></td>
</tr>";
}
echo "</table>";
echo "</div>";
