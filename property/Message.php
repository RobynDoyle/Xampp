...
<div class="position-relative text-center mt-1">
  <img src="images/sky2.jpg" class="img-fluid w-100" alt="Thank you banner" style="height: 650px; object-fit: cover;">
  ...
  <div class="position-absolute top-50 start-50 translate-middle text-white bg-dark bg-opacity-50 p-4 rounded">
    ...
    <p>Our team will be working on sending a reply directly to your email soon.</p>
