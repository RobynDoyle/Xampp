...
echo "<p><a href='managecomments.php' class='btn btn-outline-primary'>Manage Comments</a></p>";
echo "<p><a href='manageproducts.php' class='btn btn-outline-primary'>Manage Products</a></p>";
echo "<p><a href='managevendors.php' class='btn btn-outline-primary'>Manage Vendors</a></p>";
} else {
